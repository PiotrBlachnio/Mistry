...
export class UrlBuilder {
    ...
    public static getManyBooksUrl({ query, maxResults = Constants.BOOK.DEFAULT_MAX_RESULTS, startIndex = Constants.BOOK.DEFAULT_START_INDEX }: IGetManyBooksParameters) {
